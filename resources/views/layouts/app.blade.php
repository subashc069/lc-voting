            ...
            <div class="w-70 mr-5">
                ...
                ">
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        <p class="text-xs mt-4">Let us Know what you would like
                            and we will take a look</p>
                    </div>

                    <form action="#" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text" class="w-full text-sm bg-gray-100
                            rounded-xl placeholder-gray-900 px-4 py-2 border-none"
                            placeholder="Your Ideas">
                        </div>
                        <div>
                            <select name="category_add" id="category_add"
                            class="bg-gray-100 text-sm w-full rounded-xl border-none
                            px-4 py-2">
                        ...
                        <div>
                            ...
                            class="w-full bg-gray-100 border-none rounded-xl
                            placeholder-gray-900 text-sm px-4 py-2"
